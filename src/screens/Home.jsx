...
    return items.filter(item => item.type === "Киреше").reduce((sum, item) => sum + item.amount, 0);
  }, [items]);
  
...
          marginBottom: '25px',
          whiteSpace: 'pre-wrap', 
          backgroundColor: darkMode ? "#2c2c1c" : '#fffbe6', 
          color: darkMode ? "#ffe066" : '#333',
          borderLeft: '5px solid #ffcc00'
      }}>
          <h3>💡 Бюджет боюнча Кеңештер:</h3>
          <p style={{ margin: 0, fontSize: '15px', lineHeight: '1.4' }}>
              {getAnalysisComment(totalIncome, items)} 
          </p>
      </div>
